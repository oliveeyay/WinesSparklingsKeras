...
'''This was inspired by articles on blog.keras.io from Francois Chollet.
We have ~325 training examples for each class, and ~100 validation examples for each class.
